...
CREATE TABLE `menu` (
  ...
  PRIMARY KEY (`id_menu`),
  KEY `id_users` (`id_penjual`),
  CONSTRAINT `menu_ibfk_1` FOREIGN KEY (`id_penjual`) REFERENCES `penjual` (`id_penjual`)
...
CREATE TABLE `nota` (
  ...
  KEY `id_menu` (`id_menu`),
  CONSTRAINT `nota_ibfk_1` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`),
  CONSTRAINT `nota_ibfk_2` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`)
...
CREATE TABLE `penjual` (
  ...
  CONSTRAINT `penjual_ibfk_1` FOREIGN KEY (`id_kelas`) REFERENCES `kelas` (`id_kelas`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `penjual` */

insert  into `penjual`(`id_penjual`,`nama_penjual`,`id_kelas`,`telp`,`email`,`password`) values 
(1,'Ibuk Path',39,'031 230011','ibukpath@gmail.com','112233');
